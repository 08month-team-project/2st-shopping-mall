...
public class QCartItem extends EntityPathBase<CartItem> {
    ...
    private static final long serialVersionUID = 825002456L;
    ...
    public final com.example.shoppingmall.domain.item.domain.QItem item;
    ...
    public QCartItem(Class<? extends CartItem> type, PathMetadata metadata, PathInits inits) {
        ...
        this.item = inits.isInitialized("item") ? new com.example.shoppingmall.domain.item.domain.QItem(forProperty("item"), inits.get("item")) : null;
    }
